...
Route::middleware(['auth:tbl_user', 'checkrole'])->group(function () {
    ...
    Route::get('/panelperesean/{kode_pereseanuser}/addraperkada', [DataraperkadaController::class, 'addraperkada'])->name('addraperkada');
    Route::get('/panelperesean/{kode_pereseanuser}/{id_draft_permohonan}/editraperkada', [DataraperkadaController::class, 'editraperkada'])->name('editraperkada');
    Route::get('/panelperesean/hapusdatalampiran/{id_draft_permohonan}', [DataraperkadaController::class,'hapusdatalampiran'])->name('editraperkada.hapus_rowdatatambahan');
    ...
    //Route::post('/panelperesean/storeraperkada', [DataraperkadaController::class, 'storeraperkada'])->name('storeraperkada');
    Route::post('/panelperesean/{kode_pereseanuser}/storeraperkada', [DataraperkadaController::class, 'storeraperkada'])->name('storeraperkada');
    Route::post('/panelperesean/{kode_pereseanuser}/updateraperkada', [DataraperkadaController::class, 'updateraperkada'])->name('updateraperkada');
    Route::post('/panelperesean/{kode_pereseanuser}/replacedata', [DataraperkadaController::class, 'replacedata'])->name('replacedata');
