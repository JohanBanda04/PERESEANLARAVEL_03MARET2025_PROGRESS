...
@section('content')
            ...
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        ...
                        @endphp
                        Data &nbsp;<i>Raperkada</i> &nbsp;{{ $fullname_bykodepereseanuser }}
                    </h2>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <a href="{{ route('addraperkada',$kode_pereseanuser) }}" class="btn btn-primary"
                                       id="{{--btnTambahBeritaPereseanuser--}}">
                                    ...
                                    <table class="table table-bordered"
                                        ...
                                        @foreach($draft_raperkada as $d)
                                           ...
                                           margin: 0 auto; overflow-x: auto; white-space: nowrap;">{{ $d->nama_draft_permohonan }}</td>
                                                ...
                                                <td style=" max-width: -moz-fit-content; max-width: fit-content;
                                           margin: 0 auto; overflow-x: auto; white-space: nowrap;">{{ $d->nama_perancang==""?"-":$d->nama_perancang }}</td>

                                                <td style=" max-width: -moz-fit-content; max-width: fit-content;
                                           margin: 0 auto; overflow-x: auto; white-space: nowrap;">{{ ucfirst(str_replace('_',' ',$d->status)) }}</td>
                                                <td style=" max-width: -moz-fit-content; max-width: fit-content;
                                           ...
                                           margin: 0 auto; overflow-x: auto; white-space: nowrap;">
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="{{ route('editraperkada',[$kode_pereseanuser,encrypt($d->id_draft_permohonan),]) }}" class="{{--editberita--}} btn-sm"
                                                           style="background-color: #1e35bc; border-radius: 5px;
                                                           color: white; margin-left: 8px;"
                                                           id_berita="{{--{{ $d->id_berita }}--}}"
                                                           title="Edited By Pemda?">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                 class="icon icon-tabler icon-tabler-edit" width="24"
                                                                 height="24" viewBox="0 0 24 24" stroke-width="2"
                                                                 stroke="currentColor" fill="none"
    ...
    <div class="modal modal-blur fade" style="" id="modal-inputberitapereseanuser" tabindex="-1" role="dialog"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="width: 1000px;" role="document">
            <div class="modal-content" style="">
                <div class="modal-header">
                    <h5 style="font-weight: bold" class="modal-title">Tambah Data
                        &nbsp;<i>Raperkada</i> {{ $pereseanuser->nama_lengkap }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body " style="">
                    <form action="{{--{{  route('storeberita') }}--}}" method="post" id="frmBeritaSatker"
                          name="frmBeritaSatker"
                            ...
                            <div class="col-12">
                                ...
                                <span class="input-icon-addon">
                                  <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                                    ...
                                    <input readonly type="text" value="{{ $kode_pereseanuser }}"
                                           class="form-control"
                                           name="kode_pereseanuser"
                                           id="kode_pereseanuser"
                            ...
                            <div class="col-12">
                                ...
                                <span class="input-icon-addon">
                                  <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                                    ...
                                    <input type="text" value="" class="form-control" name="judul_raperkada"
                                           id="judul_raperkada"
                                           placeholder="Tambah Judul Raperkada" {{--required--}}>
                                </div>
                            </div>
                        </div>
...
@push('myscript')
    <script>
        $(function () {
            ...
            $('#btnTambahBeritaPereseanuser').click(function () {
                //alert("tes");
                //return false;
                $('#modal-inputberitapereseanuser').modal('show');
            });
